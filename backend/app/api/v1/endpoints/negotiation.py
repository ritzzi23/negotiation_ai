...
from ....core.models import (
    NegotiationRun, Message, Offer, Buyer, BuyerItem, Seller, NegotiationOutcome
)
from ....models.api_schemas import (
    SendMessageRequest,
    SendMessageResponse,
    NegotiationStateResponse,
    NegotiationOutcomeInfo,
...
async def force_decision(
    ...
    try:
        ...
        return {
            ...
            "recommended_card": outcome.recommended_card,
            "card_savings": outcome.card_savings,
...
async def get_negotiation_state(
    ...
    with get_db() as db:
        ...
        outcome = db.query(NegotiationOutcome).filter(
            NegotiationOutcome.negotiation_run_id == room_id
        ).first()
        if outcome:
            outcome_info = NegotiationOutcomeInfo(
                decision_type=outcome.decision_type,
                selected_seller_id=outcome.selected_seller_id,
                final_price=outcome.final_price_per_unit,
                quantity=outcome.quantity,
