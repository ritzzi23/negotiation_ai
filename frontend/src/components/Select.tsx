  ...
  return (
    <div className="w-full">
      ...
      <select
        id={selectId}
        className={clsx(
          'w-full px-3 py-2 border rounded-xl bg-white text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-300 transition-colors appearance-none',
          error
