                ...
                <div key={item.item_id} className="bg-neutral-50 rounded-lg p-4 border border-neutral-200">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <ProductAutocompleteInput
                      ...
                      onValueChange={(value) => updateShoppingItem(index, { ...item, item_name: value })}
                  ...
                  <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Input
                      label="Variant"
                      value={item.variant || ''}
                      onChange={(e) => updateShoppingItem(index, { ...item, variant: e.target.value })}
                    ...
                    <Input
                      ...
                      onChange={(e) => updateShoppingItem(index, { ...item, size_unit: e.target.value })}
                      placeholder="e.g. ml"
                    />
                  </div>
